...
//        .products().add(ProductOutputRow().name("Acai berry, at farm (WFLDB 3.7)/BR U")
//            .unit("kg")
...
//    Avoided products
        ...
        .resources().add(
            ElementaryExchangeRow()
                ...
                .uncertainty(
                    UncertaintyRecord.logNormal(1.0744)
                )
        )

//                    Resources
//                    ;; kg;;Lognormal;1.0744;0;0;(2,2,1,1,1,na)
//
//    Energy, gross calorific value, in biomass;;MJ;20295.524449877732;Lognormal;1.0744;0;0;(2,2,1,1,1,na)
//
//    Water, well, BR;in water;m3;501.95555914578216;Lognormal;1.0714;0;0;(2,1,1,1,1,na)
//
//    Water, river, BR;in water;m3;2170.792762893368;Lognormal;1.0714;0;0;(2,1,1,1,1,na)
//
//    Occupation, permanent crop, irrigated;land;m2a;10000.0;Lognormal;1.1130;0;0;(2,1,1,1,1,na)
//
//    Transformation, from permanent crop, irrigated;land;m2;500.0;Lognormal;1.2077;0;0;(2,1,1,1,1,na)
//

...
process acai_berry_at_farm_br8553_1886 {
    ...
    resources {
        ...
        // (2,1,1,1,1,na)
        2170.792762893368 m3 water_river_br(compartment = "raw", sub_compartment = "in water" ) 
        // (2,1,1,1,1,na)
        2170.792762893368 m3 water_river_br(compartment = "raw", sub_compartment = "in water" ) 
        // (2,1,1,1,1,na)
        2170.792762893368 m3 transformation_from_permanent_crop_irrigated(compartment = "raw", sub_compartment = "in water" ) 
        // (2,1,1,1,1,na)
        2170.792762893368 m3 water_river_br(compartment = "raw", sub_compartment = "in water" ) 
    }
    ...
    land_use {
        // (2,1,1,1,1,na)
        10000.0 m2a occupation_permanent_crop_irrigated(compartment = "raw", sub_compartment = "land" ) 
        // (2,1,1,1,1,na)
        10000.0 m2a occupation_permanent_crop_irrigated(compartment = "raw", sub_compartment = "land" ) 
        // (2,1,1,1,1,na)
        500.0 m2 transformation_to_permanent_crop_irrigated(compartment = "raw", sub_compartment = "land" ) 
    }
...
process waste6422_6422 {
    ...
    emissions { // To Air
        // (2,2,1,1,1,na)
        9752559010.236041 kg carbon_dioxide2_in_air(compartment = "air", sub_compartment = "in air" )  // Formula=[145.56 * 67E6 / (1 -4E-6)]
    }

    emissions { // To Water
        // (2,2)
        6 g carbon_dioxide3_in_water(compartment = "water", sub_compartment = "in water" )  // Formula=[3 * 2]
    }

    emissions { // To Soil
        // (2,2)
        6 g carbon_dioxide4_in_soil(compartment = "soil", sub_compartment = "in soil" )  // Formula=[3 * 2]
    }

    emissions { // Economics
        // (2,2)
        6 g carbon_dioxide5_in_economics(compartment = "economic", sub_compartment = "in economics" )  // Formula=[3 * 2]
    }

    emissions { // Non Material
        // (2,2)
        6 g carbon_dioxide7_in_non_mat(compartment = "non_mat", sub_compartment = "in non mat" )  // Formula=[3 * 2]
    }

    emissions { // Social
        // (2,2)
        6 g carbon_dioxide6_in_social(compartment = "social", sub_compartment = "in social" )  // Formula=[3 * 2]
    }
...
process acai_berry_at_farm_br8553_1886 {
    ...
    emissions { // To Air
        // (2,2,1,1,1,na)
        9752559010.236041 kBq argon_41(compartment = "air", sub_compartment = "low. pop." )  // Formula=[145.56 * 67E6 / (1 -4E-6)]
    }
    ...
    resources {
        ...
        9752559010.236041 kg diethylene_glycol(compartment = "raw", sub_compartment = "in air" )  // Formula=[145.56 * 67E6 / (1 -4E-6)]
        // Formula & Resolution
        3.6 kg dolomite(compartment = "raw", sub_compartment = "in ground" )  // Formula=[1.2 * 3], Fallback for [Dolomite, Resource, raw, in ground]
    }

    land_use {
        // (2,1,1,1,1,na)
        10000.0 m2a permanent_crops_irrigated(compartment = "raw", sub_compartment = "land" )  // Fallback for [Occupation, permanent crop, irrigated, Land_use, raw, land]
    }

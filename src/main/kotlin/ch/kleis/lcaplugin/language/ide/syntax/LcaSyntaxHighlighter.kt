...
class LcaSyntaxHighlighter : SyntaxHighlighterBase() {
    ...
    override fun getTokenHighlights(tokenType: IElementType): Array<TextAttributesKey> {
        return when (tokenType) {
            PROCESS_KEYWORD, SUBSTANCE_KEYWORD, PRODUCTS_KEYWORD, META_KEYWORD, LAND_USE_KEYWORD, IMPACT_KEYWORD,
            ...
            TYPE_KEYWORD, UNIT_KEYWORD, REFERENCE_KEYWORD -> FIELD_KEYS
            TokenType.BAD_CHARACTER -> BAD_CHARACTER_KEYS
            NUMBER -> NUMBER_KEYS
            COMMENT_BLOCK_START, COMMENT_BLOCK_CONTENT, COMMENT_BLOCK_END -> BLOCK_COMMENT_KEYS
            else -> EMPTY_KEYS
        }
    }
}

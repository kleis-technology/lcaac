...
class LcaLangAbstractParser(
    ...
    private fun technoProductExchange(
            ...
            ETechnoExchange(quantity(psiExchange.getQuantity()),
    ...
    private fun technoProductExchangeWithAllocation(
            ...
            ETechnoExchange(
                    ...
                    productSpec(psiExchange.getTechnoProductExchange().getProductRef())
                            .copy(referenceUnit = EUnitClosure(symbolTable, EUnitOf(quantity(psiExchange.getTechnoProductExchange().getQuantity())))),

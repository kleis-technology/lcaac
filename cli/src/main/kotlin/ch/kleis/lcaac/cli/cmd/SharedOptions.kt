...
fun CliktCommand.sourceOption() = option("-s", "--source", help = "Path to LCA source folder or zip/tar.gz file")
    .file()
    .default(Path(".").toFile())
    .help("Path to LCAAC source folder or zip/tar.gz file. Defaults to current working directory.")
